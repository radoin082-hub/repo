...
INSERT INTO `users` (`id`, `first_name`, `second_name`, `third_name`, `fourth_name`, `full_name`, `email`, `password`, `education_level`, `Average`, `Ranking`) VALUES
	...
	(14, 'fofa', 'dikra', 'huda', 'asia', 'GROUPE1', 'groupe@gmail.com', '$2y$10$5TY8E07YCxVqCFeUqKhS..7wp9XN3Hk/HIPHz8kopAI4ZOPbDbyEq', 'L3', 10, 1),
	...
	(23, 'onax', 'xano', '', '', 'samer', 'amrisamer54@gmail.com', '$2y$10$zudkHQeweT9iDHhI6vGq1eTJXc11HolZY6RL9xbKuV8/hfD47QeeS', 'M2', 0, 0);
